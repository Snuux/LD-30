...
function Tutorial:update(dt)
  ...
  gui.group{grow = "down", pos = {windowW/2, windowH/2}, function()
      ...
      elseif t == 4 then
        gui.Label{text = "Left-Click to start create wall...", align = "center", size = {1, 1}}
        Tutorial.s = 1
      elseif t == 5 then
      ...
      elseif t == 8 then
        ...
        Tutorial.s = 2
      elseif t == 9 then
        gui.Label{text = "Go-o-od l-u-c-k! (Left-Click)", align = "center", size = {1, 1}}
        Tutorial.s = 3
      end
  end}
  ...
  if t >= 10 and t < 20 then
    gui.group{grow = "down", pos = {windowW/2, windowH - 100}, function()
          gui.Label{text = "[Left-Click] to boost your 'friend', and [Right-Click] to move him in CONNECTED world!", align = "center", size = {1, 1}}
        end}
  end
end
